...
export function OverviewPreviewApp() {
  ...
  if (loading) return <main className="overview-preview-state">Загрузка обзора продуктов…</main>;
  ...
  return <div className="overview-preview-shell">
    <header className="overview-preview-header">
      <div><span>IMDS CONTROL CENTER</span><h1>Обзор продуктов</h1><p>Организации · продукты · модули · entitlement · синхронизация</p></div>
