import {
  ...
  CircleDollarSign, CloudCog, Gauge, Headphones, LayoutDashboard, LockKeyhole, LogOut,
  Network, PackageCheck, ReceiptText, Search, Settings, ShieldAlert, ShieldCheck, Users, Webhook,
} from 'lucide-react';
