import {
  Activity, AlertTriangle, AppWindow, BadgeDollarSign, BarChart3, Bell, Boxes, Building2, ChevronRight,
  CircleDollarSign, CloudCog, DatabaseBackup, Gauge, Headphones, LayoutDashboard, LockKeyhole,
  LogOut, Network, PackageCheck, Puzzle, ReceiptText, Search, Settings, ShieldAlert, ShieldCheck, Users, Webhook,
} from 'lucide-react';
...
import { ProductPaymentMethodsPage } from './features/billing/ProductPaymentMethodsPage';
...
const nav:NavigationItem[]=[
 ...
 {to:'/modules',label:'Модули',icon:Puzzle,permission:'modules.read'},
...
export function App(){return <Shell><Routes>
 ...
 <Route path="/modules" element={<RequirePermission permission="modules.read"><ModulesPage/></RequirePermission>}/>
 ...
 <Route path="/settings" element={<RequirePermission permission="settings.read"><ProductPaymentMethodsPage/></RequirePermission>}/>
</Routes></Shell>}
